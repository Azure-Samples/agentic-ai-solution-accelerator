...
## Skills
1. [ ] We have engineers comfortable with FastAPI + Python 3.11+.
2. [ ] We have engineers comfortable with Bicep (reading + authoring modules).
3. [ ] We have engineers who have shipped at least one production LLM application on any cloud.
4. [ ] We have an engineer responsible for RAI / responsible AI posture.
5. [ ] We have an engineer who has handled a production LLM incident (cost excursion, prompt injection, grounding failure).

## Tooling
6. [ ] We use GitHub as our source of truth.
7. [ ] We have GitHub Copilot Business or Enterprise seats.
8. [ ] We use GitHub Actions for CI.
9. [ ] We have experience with Azure AI Foundry (not just Azure OpenAI direct).
10. [ ] We have experience with App Insights custom events + KQL.
